...
RESULT_FILE_PATH = os.path.join(PROJECT_ROOT, 'outputs/spacellava_logs/test_results_spacellava.jsonl')
FILE_PATH = os.path.join(PROJECT_ROOT, 'src/datasets/data/dev.jsonl')
IMAGE_DIR = os.path.join(PROJECT_ROOT, 'data/images/COCO2017/')
PEFT_MODEL_ID = os.path.join(PROJECT_ROOT, 'outputs/spacellava_checkpoints/saved_model')
# ======================================================================
...
with open(FILE_PATH, 'r', encoding="utf-8") as f, open(RESULT_FILE_PATH, 'w+', encoding="utf-8") as fout:
    for line in f:
        ...
        # SpaceLLaVA prompt used in the reference script
...
print(f'\n=================================')
print(f'Final SpaceLLaVA Accuracy: {accuracy:.4f}')
print(f'=================================')
