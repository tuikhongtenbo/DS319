...
def convert_to_llava_format(data_path: str, output_path: str):
    path = Path(data_path)
...
def run_train(args, config: ExperimentConfig):
    ...
    # 1. Convert dataset to LLaVA conversational format
    ...
    convert_to_llava_format(data_path, str(formatted_data_path))
    
    # 2. Generate training shell script
